...
const factsHandler = () => {
    ...
    switch (randomNumber) {
        case 0:
            return "\nJeepers what a significant birthday you have! Lot’s of crazy things have happened on June 7th over the years. Henry II is crowned king of Germany. The Americans are victorious at the battle of midway. Most importantly also the same birthday as Iggy Azalea, coincidence?🤔 I think not! 🥳"
        case 1: 
        ...
        case 2:
            return `\nHoly crap have you ever looked up your name in the dictionary? 😂 I have, I’m not kidding this is what it says: Paige
